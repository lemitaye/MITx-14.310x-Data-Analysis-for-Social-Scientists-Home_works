...
Does the blue histogram correspond to the estimator of researcher A or
researcher B?
...
Notice that `p1` corresponds to the histogram created using the mean
function (researcher A) and `p2` corresponds to the histogram created
using the median function (researcher B). We can label this as ledgends
in the plot commands as follows.
...
![](Module_5_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->

So the blue histogram corresponds to the estimator of Researcher B.

------------------------------------------------------------------------

The following figure shows the distribution for $ \_{A} $ for $ n = 100
$, and $ n = 1000 $.
